...
import './Appdev.css'; // Import the CSS file

const Appdev = () => {
  return (
    <div className="appdev-container">
      <h2>App Development Services by Code 69</h2>
      <p>At Code 69, we understand that a well-designed and seamlessly functioning mobile application can be the cornerstone of success for any startup. Our app development services are meticulously crafted to ensure that startups receive a smooth and efficient experience from concept to deployment and beyond.</p>

      <h3>1. Initial Consultation</h3>
      <p>Our app development process begins with a comprehensive consultation to understand the startup’s goals, target audience, and specific requirements. We collaborate closely with the startup’s team to gather insights and define the scope of the project.</p>

      <h3>2. Design and Prototyping</h3>
      <p>Our experienced design team creates wireframes and prototypes that visualize the app’s layout, features, and user experience. We iterate on the designs based on feedback from the startup to ensure alignment with their vision and objectives.</p>

      <h3>3. Development and Testing</h3>
      <p>Our skilled developers leverage the latest technologies and industry best practices to build the app according to the approved designs and specifications. Throughout the development process, we conduct rigorous testing to ensure the app meets high standards of quality, functionality, and performance.</p>

      <h3>4. Deployment and Launch</h3>
      <p>Once the app development is complete and thoroughly tested, we assist the startup in deploying the app to the relevant app stores (e.g., Apple App Store, Google Play Store). We provide support during the launch phase to ensure a smooth and successful rollout to users.</p>
